 ...
 */
definition(
    name: "Button Controller 3 States",
    namespace: "smartthings",
    author: "SmartThings",
    description: "Control devices with buttons like the SmartThings Button GP-U999SJVLEAA",
    category: "Convenience",
    iconUrl: "https://images-na.ssl-images-amazon.com/images/I/61sk0Ftbk6L._SL1500_.jpg",
...
def getButtonSections(buttonNumber) {
	return {
		section("Lights") {
            ...
            input "lights_${buttonNumber}_double", "capability.switch", title: "Pushed Twice", multiple: true, required: false
		}
		section("Locks") {
            ...
            input "locks_${buttonNumber}_double", "capability.lock", title: "Pushed Twice", multiple: true, required: false
		}
		section("Sonos") {
			...
			input "sonos_${buttonNumber}_double", "capability.musicPlayer", title: "Pushed Twice", multiple: true, required: false
		}
		section("Modes") {
			...
			input "mode_${buttonNumber}_double", "mode", title: "Pushed Twice", required: false
		}
		...
		if (phrases) {
			section("Hello Home Actions") {
                ...
                input "phrase_${buttonNumber}_double", "enum", title: "Pushed Twice", required: false, options: phrases
			}
		}
        section("Sirens") {
            ...
            input "sirens_${buttonNumber}_double", "capability.alarm", title: "Pushed Twice", multiple: true, required: false
        }
        ...
        section("Push Notifications") {
            ...
            input "notifications_${buttonNumber}_double", "bool", title: "Pushed Twice", required: false, defaultValue: false
        }

        section("Sms Notifications") {
            input "phone_${buttonNumber}_pushed","phone" ,title: "Pushed", required: false
            input "phone1_${buttonNumber}_pushed","phone1" ,title: "Pushed", required: false
            input "phone2_${buttonNumber}_pushed","phone2" ,title: "Pushed", required: false
            input "phone_${buttonNumber}_held", "phone", title: "Held", required: false
            input "phone1_${buttonNumber}_held", "phone1", title: "Held", required: false
            input "phone2_${buttonNumber}_held", "phone2", title: "Held", required: false
            input "phone_${buttonNumber}_double", "phone", title: "Pushed Twice", required: false
            input "phone1_${buttonNumber}_double", "phone1", title: "Pushed Twice", required: false
            input "phone2_${buttonNumber}_double", "phone2", title: "Pushed Twice", required: false
        }
	}
}
...
def executeHandlers(buttonNumber, value) {
    ...
    def phone1 = find('phone1', buttonNumber, value)
	if (phone1 != null) sendSms(phone1, textMessage ?:"Button $buttonNumber was pressed")
    def phone2 = find('phone2', buttonNumber, value)
	if (phone2 != null) sendSms(phone2, textMessage ?:"Button $buttonNumber was pressed")
